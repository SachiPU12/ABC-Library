        ...
        {
            {
                ...
                {
                    myNewConnection.Open();
                    SqlCommand myCommand = new SqlCommand("DELETE FROM Members FirstName='" + FirstName + "',LastName='" + LastName + "',Address='" + Address + "',NIC='" + NIC + "' where MemberID='" + MemberID + "'", myNewConnection);
